(function () {
  ...
  function fallbackBySrc() {
    ...
    if (src === "saved")    return "../myRecipe.html";
    if (src === "trending") return "../explore.html#trending";
    if (src === "all")      return "../explore.html#all";
    return "../explore.html";
  }
  ...
  async function load() {
    const details = await getJson("../../data/recipe-details.data.json");
